defmodule Hyde.Helpers.Cover do
  @moduledoc """
  ...
  def project do
    [app: :Hyde,
     ...,
     test_coverage: [tool: Hyde.Helpers.Cover, ignored: [Hyde.Helpers]],
     aliases: aliases]
  end
  ```
  ...
  defp get_results(opts) do
    ...
    %Hyde.Helpers.Cover{rate: rate, not_covered: nc, errors: fail, opts: opts}
  end
  ...
  defp format_results(%Hyde.Helpers.Cover{} = data) do
